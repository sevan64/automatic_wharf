...
const int servo1Pin = 12;//表記はD12 右後ろ 正の方向が後退 1100で機体は後退
//const int servo1Period = 50;
const int servo2Pin = 11;//表記はD11 前　正の方向が前身 1100で機体は前進
//const int servo2Period = 50;
const int servo3Pin = 13;//表記はD13 左後ろ 正の方向が後退 1100で機体は後退
